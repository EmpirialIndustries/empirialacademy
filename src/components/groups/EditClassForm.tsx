  ...
  useEffect(() => {
    if (classData && isOpen) {
      form.reset({
        ...
        monthly_price: classData.monthly_price.toString(),
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            <FormField control={form.control} name="title" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input placeholder="e.g., Grade 10 Maths Mastery" {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormField control={form.control} name="monthly_price" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input type="number" placeholder="e.g., 500" min="0" {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />

            <FormField control={form.control} name="schedule_days" render={() => (
              <FormItem>
                <FormLabel>Recurring Days</FormLabel>
                <div className="grid grid-cols-2 gap-2 mt-2">
                  {daysOfWeek.map((day) => (
                    <FormField key={day.id} control={form.control} name="schedule_days" render={({ field }) => (
